      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {contratos.map((contrato) => (
            ...
            >
              {/* DESTAQUE AMARELO - EXATAMENTE COMO ORIGINAL */}
              {contrato.destaque && (
                <div className="bg-yellow-500 text-white text-center py-2 px-4">
                  <span className="font-semibold text-sm">{contrato.destaque}</span>
                </div>
              )}
        ...
        {/* RODAPÉ EXATAMENTE COMO ORIGINAL */}
        <footer className="mt-16 pt-8 border-t border-gray-200 text-center">
          <div className="max-w-4xl mx-auto">
            <p className="text-gray-600 text-sm">
              © 2024 ContratosExpresso. Todos os direitos reservados.
            </p>
            <p className="text-gray-500 text-xs mt-2">
              Desenvolvido por advogados especialistas
            </p>
          </div>
        </footer>
      </div>
