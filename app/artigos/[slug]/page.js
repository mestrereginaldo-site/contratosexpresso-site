...
const artigosData = {
  ...
  'contrato-comodato': {
    ...
    conteudo: `
      <p class="lead">O comodato, ou empréstimo gratuito, é ferramenta essencial para empresas que compartilham ativos sem transferência de propriendade. Em 2025, com o crescimento da economia colaborativa, contratos bem estruturados previnem 95% dos conflitos.</p>
